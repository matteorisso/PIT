# -*- coding: utf-8 -*-
"""
Created on Tue Oct 20 15:36:46 2020
...
class LearnedConv2D(Conv2D):
    ...
    def __init__(self, gamma_trainable=True, hyst=0, **kwargs):
    ...
    def build(self, input_shape):
        ...
        self.gamma = self.add_weight(
            ...
            constraint=clip_0_1(),
            regularizer=Dilation_Reg(cf.reg_strength, input_dim, 
                self.filters, self.kernel_size[-1], l2=cf.l2),
